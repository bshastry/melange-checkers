...
def invokecj(filename):
    args = "clang --analyze -Xclang -load -Xclang /home/bhargava/work/gitlab/checkers/build-live/libusedef-checker.so -Xclang -analyzer-checker=alpha.security.StrOverflowChecker %s" % filename
...
class TestBasic(SimpleTester):
    def test_malloc(self):
        self.assertEqual(testinput('strcpy-stack-overflow.c'), True,
                         'Test on strcpy-stack-overflow.c failed')
